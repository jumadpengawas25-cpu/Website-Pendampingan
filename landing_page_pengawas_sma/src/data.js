...
export const schools = [
  {
    id: 1,
    name: "SMAN 1 Unggul",
    address: "Jl. Pendidikan No. 45, Kota Pusat",
    ...
    logoAlt: "Official logo of SMAN 1 Jakarta, featuring a classic academic crest with educational symbols like an open book and a torch, rendered in traditional navy blue and gold colors on a clean white background.",
  },
  {
    id: 2,
    name: "SMAN 5 Harapan",
    address: "Kawasan Industri Barat, Blok C",
    accreditation: { text: "Akreditasi A", class: "bg-green-100 text-green-700" },
    ...
    logoAlt: "Official school logo for SMAN 5 Harapan, minimalist and modern design with a blue geometric abstract shield and a rising sun symbol, clean white background, professional vector aesthetic.",
  },
  {
    id: 3,
    name: "SMA Brawijaya",
    address: "Lingkar Selatan, Km 12",
    ...
    logoAlt: "Traditional school crest for SMA Brawijaya, featuring an ornate shield with historical symbols and a ribbon banner, classic red and gold color palette, official and prestigious appearance.",
  },
  {
    id: 4,
    name: "SMAN 12 Prestasi",
    address: "Jl. Merdeka Baru, No. 1",
    accreditation: { text: "Akreditasi A", class: "bg-green-100 text-green-700" },
    accent: "bg-error",
    logo:
    ...
    logoAlt: "Modern high school emblem for SMAN 12 Prestasi, incorporating a stylized book and a soaring eagle, vibrant blue and white color scheme, corporate educational style.",
  },
];
